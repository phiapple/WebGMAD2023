					...
					<section className="relative h-[1594px] w-full bg-gradient-to-b from-c-blue to-c-green ">
						<div className="min-h-screen-no-header container mx-auto grid place-items-center px-10 md:w-[1272px] md:px-0 lg:h-[671px]">
							...
							>
								...
								<p className="text-center text-sm text-white md:text-lg" data-aos="fade-up">
									National Accounting Olympiad (NAO) is one of the biggest and most prestigious
									Accounting Olympiad in Indonesia. NAO presents a new and interesting olympiad
									concept, as evidence that the olympiads are fun. This competition will require
									participants to solve accounting problems that are packaged in fun, exciting, and
									challenging rounds. NAO 2023 consists of four stages : preliminary, quarter final,
									semi final, and final. Knowledge, teamwork, and strategy will be the capabilities
									that are expected to be present to NAO participants.
								</p>
							</div>
						</div>
						<div className=" mx-auto flex justify-center px-[40px]">
							...
							>
								...
								<h2 className="mt-4 text-center text-2xl text-white md:text-4xl" data-aos="fade-up">
									“Environmental Accounting : Integrating Environmental Management Accounting to
						...
						<div className="mx-auto my-10 max-w-[1088px] px-4">
							<p className="text-center text-lg text-white md:text-xl" data-aos="fade-up">
								Environmental accounting is one of the fascinating topics to discuss. NAO 2023
								incorporates this sub-theme to help participants gain a better understanding of the
								importance of sustainable supply chain management for a better generation.
							</p>
						</div>
					</section>
