            ...
            <div className="min-h-screen-no-header container mx-auto grid h-[671px] w-[296px] place-items-center px-0 md:w-[1272px]">
              ...
              >
                ...
                <p
                  ...
                  data-aos="fade-up"
                >
                  National Accounting Olympiad (NAO) Junior is making its debut
                  at GMAD 2023, aiming to discover young accounting talents,
                  especially among high school students or their equivalent. NAO
                  Junior consists of a series of tests that will be packaged in
                  a competition system that is both enjoyable and challenging
                  for the participants. As part of the Gadjah Mada Accounting
                  Days, NAO Junior comprises four rounds: Online Preliminary,
                  Quarter Final, Semifinal, and Final, which require knowledge,
                  teamwork, and strategic thinking from the participants. NAO
                  Junior is ready to provide an exciting competition and an
            ...
            <div className=" mx-auto flex justify-center px-[40px]">
              ...
              >
                ...
                <h2
                  ...
                  data-aos="fade-up"
                >
                  "Sustainable Accounting Governance: The Role of Accountants
                  for ESG Challanges and Opportunities in the Digital Era"
                </h2>
              </div>
            </div>
