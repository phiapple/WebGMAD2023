	...
	return (
		<BaseLayout>
			<div className="w-screen bg-[#F0F0F0] font-montserrat">
				...
				<section className="relative grid place-content-center bg-gradient-to-b from-c-blue to-c-green pt-24 md:pt-[200px]">
					<div className="container relative mx-auto flex flex-col-reverse items-center justify-between md:flex-row">
						...
						<div className="relative flex flex-col gap-9 md:w-[64%]">
							...
							<p data-aos="fade-up" className="relative text-xs text-c-white max-xl:text-sm">
								Gadjah Mada Accounting Days (GMAD) is the biggest annual event of the Department of
								Accounting FEB UGM and organized by Ikatan Mahasiswa Akuntansi Gadjah Mada
								(IMAGAMA). GMAD consists of several series of events such as accounting
								competitions, multidisciplinary case studies, a seminar titled talk show, and many
								more, aiming to be a channel for the potential of Indonesian students,
								practitioners, and academics to accelerate and integrate their potentials in the
								field of economics, particularly accounting.
							</p>
							<a
								data-aos="fade-up"
						...
						<div data-aos="fade-up" className="relative mb-8 w-1/4 max-w-[40vh] md:mb-0">
							<Image
								src="/images/logo.svg"
								alt="GMAD logo"
								height={200}
							...
							{events.map((event, index) => (
								...
								>
									<div class="flex flex-col gap-2 md:gap-4">
										...
										<p className="text-md font-bold text-c-orange">{event.title}</p>
				...
				<section className="bg-gradient-to-b from-c-green to-c-blue max-md:py-12">
					<div className="container mx-auto flex flex-col items-center justify-center gap-6 md:h-[640px] md:max-h-[560px] md:flex-row">
						...
						<div className="relative flex h-full flex-col items-start justify-center">
							...
							<p data-aos="fade-up" className="relative text-xl text-c-white md:text-h3">
				...
				<section className="">
					<div className="container mx-auto flex flex-col items-center justify-center gap-8 py-16 md:gap-30 md:py-[120px]">
						...
						<div className="flex w-1/2 flex-col text-center">
							<h3 data-aos="fade-up" className="mb-14 text-[32px] font-semibold text-c-green">
								Sponsors
							</h3>
				...
				<section className="">
					<div data-aos="fade-up" className=" container mx-auto py-[32px] md:py-[120px]">
